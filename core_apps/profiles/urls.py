...
from .views import (
    ...
    MinderProfileDetailAPIView,
    NonParentProfileListAPIView,
)

urlpatterns = [
    path("all/", ProfileListAPIView.as_view(), name="profile-list"),
    path("non-parent-profiles/", NonParentProfileListAPIView.as_view(), name="non-parent-profiles"),
    path("user/my-profile/", ProfileDetailAPIView.as_view(), name="profile-detail"),
    path("non-parent-profile/<int:id>/", MinderProfileDetailAPIView.as_view(), name='minder-profile-detail'),
