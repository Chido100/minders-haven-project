...
class ContentView(TimeStampedModel):
    ...
    user = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name="content_views", verbose_name=_("User")
    )
    ...
    def record_view(cls, content_object, user:User, viewer_ip: str) -> None:
        ...
        try:
            view, created = cls.objects.get_or_create(content_type = 
            content_type, object_id = content_object.pkid, defaults=
