...
ALLOWED_HOSTS = [".mindershaven.co.uk"]

ADMINS = [("Chidozie Amefule", "dozie_chido@outlook.com"),]
...
CSRF_TRUSTED_ORIGINS = ["https://mindershaven.co.uk", "https://www.mindershaven.co.uk"]
